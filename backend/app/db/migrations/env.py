...
config.set_section_option(section, "POSTGRES_SERVER", os.environ.get("POSTGRES_SERVER", "db"))
config.set_section_option(section, "POSTGRES_PORT", os.environ.get("POSTGRES_PORT", "5432"))
config.set_section_option(section, "POSTGRES_DB", os.environ.get("POSTGRES_DB", "lol_extension"))
